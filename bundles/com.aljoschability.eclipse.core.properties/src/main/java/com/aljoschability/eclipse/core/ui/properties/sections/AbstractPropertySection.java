...
public abstract class AbstractPropertySection implements ISection {
	...
	private static final IBaseLabelProvider DUMMY_PROVIDER = new LabelProvider();
	...
	private final ElementAdaptor adaptor;

	public AbstractPropertySection(ElementAdaptor adaptor) {
